...
def _build_weekly_bot_report(docs_dir):
    ...
    neuron_map = {
        ...
        "gap_type_quality_perf":           "N671 Gap Type Quality",
        "support_level_proximity_perf":    "N672 Support Level Proximity",
        "earnings_proximity_entry_perf":   "N673 Earnings Proximity Entry",
        "technical_pattern_quality_perf":  "N674 Technical Pattern Quality",
        "market_timing_score_perf":        "N675 Market Timing Score",
        "sector_leadership_position_perf": "N676 Sector Leadership Position",
        "conviction_score_perf":           "N677 Conviction Score",
        "price_discovery_phase_perf":      "N678 Price Discovery Phase",
        "float_size_perf":                 "N679 Float Size",
        "industry_group_rank_perf":        "N680 Industry Group Rank",
        "opening_range_breakout_perf":     "N681 Opening Range Breakout",
        "news_sentiment_score_perf":       "N682 News Sentiment Score",
        "short_interest_ratio_perf":       "N683 Short Interest Ratio",
        "options_flow_signal_perf":        "N684 Options Flow Signal",
        "dark_pool_activity_perf":         "N685 Dark Pool Activity",
        "momentum_divergence_perf":        "N686 Momentum Divergence",
        "liquidity_score_perf":            "N687 Liquidity Score",
        "mean_reversion_signal_perf":      "N688 Mean Reversion Signal",
        "breakout_quality_score_perf":     "N689 Breakout Quality Score",
        "trade_grade_performance_perf":    "N690 Trade Grade Performance",
        "opening_range_breakout_perf":     "N681 Opening Range Breakout",
        "intraday_range_position_perf":    "N691 Intraday Range Position",
        "volume_weighted_trend_perf":      "N692 Volume-Weighted Trend",
        "smart_money_flow_perf":           "N693 Smart Money Flow",
        "market_structure_break_perf":     "N694 Market Structure Break",
        "order_block_level_perf":          "N695 Order Block Level",
        "imbalance_fill_perf":             "N696 Fair Value Gap Fill",
        "squeeze_momentum_state_perf":     "N697 Squeeze Momentum State",
        ...
        "gap_fill_risk_perf":                 "N741 Gap Fill Risk",
        "earnings_proximity_perf":            "N742 Earnings Proximity",
        "dividend_capture_perf":              "N743 Dividend Capture",
        "index_rebalance_perf":               "N744 Index Rebalance Signal",
        "lockup_expiry_perf":                 "N745 Lockup Expiry",
        "options_gamma_perf":                 "N746 Options Gamma",
        "put_call_skew_perf":                 "N747 Put/Call Skew",
        "implied_move_perf":                  "N748 Implied Move",
        "macro_catalyst_perf":                "N749 Macro Catalyst",
        "fed_sensitivity_perf":               "N750 Fed Sensitivity",
        "pre_market_gap_perf":                "N751 Pre-Market Gap",
        "opening_range_perf":                 "N752 Opening Range",
        "vwap_reclaim_perf":                  "N753 VWAP Reclaim",
        "intraday_momentum_perf":             "N754 Intraday Momentum",
        "closing_strength_perf":              "N755 Closing Strength",
        "multi_day_pattern_perf":             "N756 Multi-Day Pattern",
        "base_breakout_perf":                 "N757 Base Breakout",
        "trend_channel_perf":                 "N758 Trend Channel",
        "pivot_point_perf":                   "N759 Pivot Point",
        "fibonacci_level_perf":               "N760 Fibonacci Level",
        "breadth_thrust_perf":                "N761 Breadth Thrust",
        "put_call_ratio_trend_perf":          "N762 Put/Call Ratio Trend",
        "new_highs_lows_perf":                "N763 New Highs vs Lows",
        "advance_decline_perf":               "N764 Advance/Decline Line",
        "institutional_flow_perf":            "N765 Institutional Flow",
        "retail_flow_perf":                   "N766 Retail Flow",
        "smart_money_flow_perf":              "N767 Smart Money Flow",
        "fear_greed_perf":                    "N768 Fear & Greed",
        "vix_term_structure_perf":            "N769 VIX Term Structure",
        "credit_spread_perf":                 "N770 Credit Spread",
        "earnings_quality_perf":               "N771 Earnings Quality",
        "revenue_growth_perf":                 "N772 Revenue Growth",
        "margin_expansion_perf":               "N773 Margin Expansion",
        "guidance_revision_perf":              "N774 Guidance Revision",
        "insider_buying_intensity_perf":       "N775 Insider Buying Intensity",
        "institutional_ownership_change_perf": "N776 Institutional Ownership Change",
        "short_interest_trend_perf":           "N777 Short Interest Trend",
        ...
        "macro_regime_perf":                    "N801 Macro Regime",
        "fed_policy_stance_perf":               "N802 Fed Policy Stance",
        "earnings_proximity_perf":              "N803 Earnings Proximity",
        "post_earnings_drift_perf":             "N804 Post-Earnings Drift",
        "sector_etf_flow_perf":                 "N805 Sector ETF Flow",
        "position_concentration_perf":          "N806 Position Concentration",
        "intraday_structure_perf":              "N807 Intraday Structure",
        "gap_size_perf":                        "N808 Gap Size",
        "short_squeeze_risk_perf":              "N809 Short Squeeze Risk",
        "institutional_flow_perf":              "N810 Institutional Flow",
        "price_discovery_phase_perf":           "N811 Price Discovery Phase",
        "momentum_persistence_perf":            "N812 Momentum Persistence",
        "relative_volume_tier_perf":            "N813 Relative Volume Tier",
        "price_structure_quality_perf":         "N814 Price Structure Quality",
        "catalyst_recency_perf":                "N815 Catalyst Recency",
        "sector_leadership_perf":               "N816 Sector Leadership",
        "options_iv_environment_perf":          "N817 Options IV Environment",
        "breadth_alignment_perf":               "N818 Breadth Alignment",
        "entry_vs_ema_perf":                    "N819 Entry vs EMA",
        "daily_pnl_context_perf":               "N820 Daily P&L Context",
        "market_hour_context_perf":             "N821 Market Hour Context",
        "atr_environment_perf":                 "N822 ATR Environment",
        "spread_quality_perf":                  "N823 Spread Quality",
        "trend_channel_position_perf":          "N824 Trend Channel Position",
        "vwap_deviation_perf":                  "N825 VWAP Deviation",
        "pattern_signal_count_perf":            "N826 Pattern Signal Count",
        "conviction_score_tier_perf":           "N827 Conviction Score Tier",
        ...
        "breakout_quality_perf":                "N841 Breakout Quality",
        "orb_status_perf":                      "N842 ORB Status",
        "squeeze_status_perf":                  "N843 Squeeze Status",
        "price_level_perf":                     "N844 Price Level",
        "entry_rsi_zone_perf":                  "N845 Entry RSI Zone",
        "macd_signal_perf":                     "N846 MACD Signal",
        "inside_bar_context_perf":              "N847 Inside Bar Context",
        "spy_correlation_perf":                 "N848 SPY Correlation",
        "position_size_tier_perf":              "N849 Position Size Tier",
        "exit_trigger_type_perf":               "N850 Exit Trigger Type",
        "spy_trend_strength_perf":              "N851 SPY Trend Strength",
        "sector_rotation_perf":                 "N852 Sector Rotation",
        "pre_market_gap_perf":                  "N853 Pre-Market Gap",
        "relative_strength_tier_perf":          "N854 Relative Strength Tier",
        "position_count_perf":                  "N855 Position Count",
        "catalyst_strength_perf":               "N856 Catalyst Strength",
        "market_cap_momentum_perf":             "N857 Market Cap Momentum",
        "open_position_pnl_perf":               "N858 Portfolio PnL State",
        "trend_template_score_perf":            "N859 Trend Template Score",
        "score_momentum_perf":                  "N860 Score Momentum",
        "intraday_trend_quality_perf":          "N861 Intraday Trend Quality",
        "price_action_quality_perf":            "N862 Price Action Quality",
        "earnings_beat_quality_perf":           "N863 Earnings Beat Quality",
        "vcp_quality_perf":                     "N864 VCP Quality",
        "sector_etf_alignment_perf":            "N865 Sector ETF Alignment",
        "trade_count_context_perf":             "N866 Trade Count Context",
        "news_volume_perf":                     "N867 News Volume",
        "technical_setup_combo_perf":           "N868 Technical Setup Combo",
        "risk_reward_at_entry_perf":            "N869 Risk/Reward at Entry",
        "signal_freshness_perf":                "N870 Signal Freshness",
        "order_flow_imbalance_perf":            "N871 Order Flow Imbalance",
        "time_weighted_momentum_perf":          "N872 Time-Weighted Momentum",
        "relative_volume_burst_perf":           "N873 Relative Volume Burst",
        "catalyst_timing_perf":                 "N874 Catalyst Timing",
        "multi_timeframe_alignment_perf":       "N875 Multi-TF Alignment",
        "market_maker_activity_perf":           "N876 Market Maker Activity",
        "alpha_decay_risk_perf":                "N877 Alpha Decay Risk",
...
def _run():
    ...
    try:
        if trades_path.exists():
            ...
            live_market_context = {
                ...
                "recent_alpaca_trades": [
                    {"action": t.get("action"), "ticker": t.get("ticker"), "price": t.get("price"),
                     "pnl_pct": t.get("pnl_pct"), "score": t.get("score"),
                     "time": (t.get("time") or t.get("timestamp",""))[:19], "sector": t.get("sector",""),
                     "reason": (t.get("reason") or t.get("entry_thesis",""))[:60]}
                    for t in (td.get("trades") or [])[-10:]
                ],
    ...
    intel = {
        ...
        "bot_state": {
            ...
            "neurons_total":   live_market_context.get("neurons_total", 840),
