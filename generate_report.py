...
def _build_weekly_bot_report(docs_dir):
    ...
    neuron_map = {
        ...
        "institutional_ownership_perf":   "N515 Institutional Ownership",
        "float_rotation_entry_perf":      "N516 Float Rotation Entry",
        "news_sentiment_score_perf":      "N517 News Sentiment Score",
        ...
        "short_interest_ratio_perf":      "N541 Short Interest Ratio",
        ...
        "sector_relative_strength_perf":  "N545 Sector Relative Strength",
        "news_sentiment_score_perf":      "N546 News Sentiment Score",
...
def _run():
    ...
    try:
        if trades_path.exists():
            ...
            live_market_context = {
                ...
                "neurons_active":   td.get("neurons_active", 0),
                "neurons_total":    td.get("neurons_total", 510),
    ...
    intel = {
        ...
        "bot_state": {
            ...
            "neurons_total":   live_market_context.get("neurons_total", 510),
